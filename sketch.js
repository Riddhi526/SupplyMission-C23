...
function setup() {
	...
	ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:true} );
	 ...
	 block=createSprite(390,550,200,20);
	 block.shapeColor=color(255,0,0);
 
	 block1 = Bodies.rectangle(390, 525, 200, 20 , {isStatic:true} );
	  World.add(world, block1);
 
	 
	 block2=createSprite(300,500,20,100);
	 block2.shapeColor=color(255,0,0);
 
	 block3=createSprite(480,500,20,100);
